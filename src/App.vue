<template>
    <nav class="navbar navbar-expand navbar-dark bg-dark">
		<a href="/" class="navbar-brand">Perpustakaan Online V1</a>
		<div class="navbar-nav me-auto">
			...
			<li v-if="showAdminBoard" class="nav-item">
				<router-link to="/admin" class="nav-link">Borrow List</router-link>
			</li>
			...
			<li class="nav-item">
					<router-link v-if="currentUser" to="/user" class="nav-link">Book List</router-link>
				</li>
